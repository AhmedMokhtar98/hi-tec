...
import '../css/inquiries_control.css'
...
export default function InquiresControl() {
    ...
    return (
       ...
       <div className="Page_Container">
            <div className="Page_Header"> 
                <GoBack/>
                {!matches1 && <HeaderMenu/>}
                <div className="Header_word">استعلامات معلقة</div>
            </div>
                ...
                : 
                    <>
                        {data.length > 0 ? 
                            <>
                            {data.map((item, i)=>(
                                <tr className="table_tr" key={i} onClick={(e)=>InquiryInfo(item.nat_id)}>  
                                    <td className="table_td inquiries_td"> {item.username}</td>
                                    <td className="table_td inquiries_td"> {item.nat_id}</td>
                                    <td className="table_td inquiries_td"><div>{item.branch}</div></td>
                                    <td className="table_td inquiries_td"> {item.date}</td>
                                </tr>
                            ))} 
                            </>
